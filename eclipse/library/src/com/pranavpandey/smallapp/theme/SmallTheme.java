...
/**
 * A class to detect Primary and Accent colors from the theme. Only for Xperia devices
...
public class SmallTheme {
     ...
     */
    public SmallTheme(Context context, @ColorInt int defaultPrimaryColor,
    ...
    public static synchronized void initializeInstance(Context context,
                                                       ...
                                                       @ColorInt int defaultAccentColor,
                                                       @ColorInt int defaultPrimaryColorDark,
                                                       @ColorInt int defaultAccentColorDark) {
        if (context == null) {
            throw new NullPointerException("Context should not be null");
        }
    ...
    public static synchronized void initializeInstanceRes(Context context,
                                                          ...
                                                          @ColorRes int defaultAccentColorId,
                                                          @ColorRes int defaultPrimaryColorDarkId,
    ...
    public int[] getAllColors() {
        return new int[] { getPrimaryColor(), getAccentColor(), getTintPrimaryColor(),
                getTintAccentColor(), getPrimaryColorDark(), getAccentColorDark(),
    ...
    public int[] getAllLightColors() {
        return new int[] { getPrimaryColor(), getAccentColor(),
                getTintPrimaryColor(),  getTintAccentColor() };
    }
