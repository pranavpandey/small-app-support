 ...
 * 
 * @see {@link com.pranavpandey.smallapp.dialog.ActionDialog.Type}, {@link android.widget.ArrayAdapter}.
 */
public class BaseActionItemAdapter extends ArrayAdapter<BaseActionItem> {
	 ...
	 */
	public BaseActionItemAdapter(Context context, List<BaseActionItem> list, @LayoutRes int layoutId) {
