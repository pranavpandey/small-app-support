 ...
 * 
 * @see {@link android.app.AlertDialog}, {@link com.pranavpandey.smallapp.adapter.BaseActionItemAdapter}, 
...
public class ActionDialog {
	 ...
	 * {@link #getAdapter()}. 
	 */
	public ActionDialog setAdapter(@NonNull ListAdapter adapter, OnActionItemClickListener actionItemListener) {
	...
	public ActionDialog setCheckButtonLayout(@StringRes int textId, boolean defaultState,  
		...
		this.mCheckButtonText = mContext.getText(textId);
